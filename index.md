...
#### Summary
Overall, our website had a positive feedback from UH community members with an average rating of 8.75/10. All of the users agree that our website looks nice, is easy to understand and navigate, and that the website would be useful when looking for a club. Some of the users noticed that our add club feature was not fully functional; however, this issue was fixed promptly. Another user noticed that the user home page listed clubs that they did not join; this issue was also fixed in a recent update. We were also provided with suggestions for future improvements such as separating the list club section in the user home page into a section for clubs that they own and a section for clubs that they are members of, adding a feature to schedule and show meeting times, a way to search for other users and add them as a friend to give the site a social aspect, making club images load faster in the browse clubs page, having a dark theme, adding contact info of the admin on the website in case of an error, and having an alphabetical navigation to make it easier and quicker to find clubs.
